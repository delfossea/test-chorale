...
function input(string $name, string $label, string|int|float|null $value='', string $type='text', bool $required=false): string { return '<label>'.$label.'<input type="'.$type.'" name="'.$name.'" value="'.h((string)$value).'" '.($required?'required':'').'></label>'; }
